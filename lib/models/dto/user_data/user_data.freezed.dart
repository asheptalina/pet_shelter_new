...
class _$_UserData with DiagnosticableTreeMixin implements _UserData {
  const _$_UserData({required this.userName, required this.avatarUrl});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UserData(userName: $userName, avatarUrl: $avatarUrl)';
  }
...
abstract class _UserData implements UserData {
  const factory _UserData(
      ...
      required final String? avatarUrl}) = _$_UserData;
